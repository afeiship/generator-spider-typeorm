...
module.exports = class extends Generator {
    ...
    this.log(
      yosay(
        `Welcome to the stunning ${chalk.red(
          "generator-generator-spider-typeorm"
        )} generator!`
      )
    );
  ...
  writing() {
    ...
    remote("afeiship", "boilerplate-spider-typeorm", (_, cachePath) => {
      this.fs.copy(
    ...
    replace.sync({
      files,
      from: [
        /boilerplate-spider-typeorm-description/g,
        /boilerplate-spider-typeorm/g,
        /boilerplate-scope/g,
        /GeneratorSpiderTypeorm/g
      ],
